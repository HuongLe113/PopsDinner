...
namespace popsDiner.Infrastructure.Persistence
{
    public class ShoppingCart
    {
        ...
        {   foreach(var i in _appDbContext.shoppingCartItems)
        {
            _appDbContext.shoppingCartItems.Remove(i);
        }
        _appDbContext.SaveChanges();
            var shoppingCartItem =
                     _appDbContext.shoppingCartItems.AsNoTracking().SingleOrDefault(s => s.Item.ItemId == item.ItemId && s.ShoppingCartId == ShoppingCartId);
